...
reload the entirety of our code using DLL-based [fn::[[https://slembcke.net/blog/HotLoadC][Easy Hot-Loading for C]]]
This way, we get a buffer to the string of a new shader anytime we recompile.
